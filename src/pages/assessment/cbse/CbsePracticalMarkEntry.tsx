...
export function CbsePracticalMarkEntry() {
      ...
      <div className="bg-white rounded-xl border border-gray-200 shadow-sm overflow-hidden">
            ...
            <table className="w-full text-sm border-collapse">
              <thead>
                ...
                <th
                  key={e.id}
                  colSpan={2}
                  className="px-4 py-3 text-center text-xs font-bold text-blue-700 uppercase bg-blue-50 border-l border-blue-200">
                  ...
                  <th className="px-4 py-3 text-center text-xs font-bold text-gray-500 uppercase bg-indigo-50 border-l border-indigo-200">
                    Total
                    <br />
                  ...
                  <th className="px-4 py-3 text-center text-xs font-bold text-gray-500 uppercase bg-indigo-50">
                    %
                  </th>
                  <th className="px-4 py-3 text-center text-xs font-bold text-gray-500 uppercase bg-indigo-50">
                    Overall Grade
                ...
                <tr className="bg-white border-b">
                  ...
                  {exams.map((e) =>
                <Fragment key={e.id}>
                      <th className="px-3 py-2 text-center text-[10px] font-semibold text-gray-400 uppercase bg-blue-50/50 border-l border-blue-100">
                        Marks
                      </th>
                      <th className="px-3 py-2 text-center text-[10px] font-semibold text-gray-400 uppercase bg-blue-50/50">
                        Grade
                      </th>
                    </Fragment>
                )}
                  <th className="px-4 py-2 bg-indigo-50/50 border-l border-indigo-100"></th>
                  <th className="px-4 py-2 bg-indigo-50/50"></th>
                  <th className="px-4 py-2 bg-indigo-50/50"></th>
                </tr>
              </thead>
                ...
                return (
                  <tr
                    ...
                    className="hover:bg-gray-50/50 transition-colors">
                      ...
                      return (
                        <Fragment key={e.id}>
                            <td className="px-3 py-3 text-center bg-blue-50/30 border-l border-blue-100">
                              <input
                              type="text"
                              value={v}
                              onChange={(ev) =>
                              ...
                              className={`w-14 py-1.5 border-2 rounded-lg text-center text-sm font-bold outline-none transition-all ${v === '' ? 'border-gray-200 focus:border-blue-400' : valid ? 'border-green-300 bg-green-50 text-green-700' : 'border-red-300 bg-red-50 text-red-700'}`}
                              placeholder="—" />
                      ...
                      <td className="px-4 py-3 text-center bg-indigo-50/30 border-l border-indigo-100 font-black text-gray-900">
                        {total > 0 ? total : '—'}
                      </td>
                      <td className="px-4 py-3 text-center bg-indigo-50/30 font-semibold text-gray-700">
                        {total > 0 ? `${pct}%` : '—'}
                      </td>
          ...
          <div className="p-4 border-t bg-gray-50 flex items-center justify-between">
            <div className="flex items-center gap-2 text-sm text-gray-500">
              ...
              <span>
                Grade is auto-calculated from total marks across all exams in{' '}
                {term}
              </span>
            </div>
