...
export function GsebExamMaster() {
      ...
      <div className="flex items-center gap-3">
        ...
        <div>
          <h1 className="text-2xl font-bold text-gray-900">
            GSEB — Re-Exam Mark Entry
          </h1>
          <p className="text-sm text-gray-500">
            Enter marks for students appearing in GSEB supplementary
            examinations
          </p>
        </div>
      </div>
                      ...
                      className={`transition-colors ${passed === false && valid ? 'bg-red-50/40' : 'hover:bg-gray-50/50'}`}>
                        ...
                        <td className="px-3 py-3 text-center bg-teal-50/30 border-l border-teal-100">
                          <div className="flex flex-col items-center gap-0.5">
                            ...
                            placeholder="—"
                            className={`w-16 py-1.5 border-2 rounded-xl text-center text-sm font-bold outline-none transition-all ${s.reExamMarks === '' ? 'border-gray-200 focus:border-teal-400' : valid ? 'border-green-300 bg-green-50 text-green-700' : 'border-red-300 bg-red-50 text-red-700'}`} />
