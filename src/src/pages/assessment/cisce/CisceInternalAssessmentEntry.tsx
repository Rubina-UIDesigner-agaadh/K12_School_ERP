...
export function CisceInternalAssessmentEntry() {
      ...
      <div className="flex items-center gap-3">
        ...
        <div>
          <h1 className="text-2xl font-bold text-gray-900">
            CISCE — Consolidate Result Mark Entry
          </h1>
          <p className="text-sm text-gray-500">
            Enter Theory, Practical & Internal marks for consolidated CISCE
            result
          </p>
        </div>
      </div>
          ...
          <div className="bg-white rounded-xl border border-gray-200 shadow-sm overflow-hidden">
              ...
              <table className="w-full text-sm">
                <thead className="bg-gray-50 border-b">
                  <tr>
                    ...
                    <th className="px-3 py-3 text-center text-xs font-bold text-violet-600 uppercase bg-violet-50 border-l border-violet-200">
                      Practical
                      <br />
                    ...
                    <th className="px-3 py-3 text-center text-xs font-bold text-indigo-600 uppercase bg-indigo-50 border-l border-indigo-200">
                      Internal
                      <br />
                    ...
                    <tr
                      ...
                      className={`transition-colors ${pass === false ? 'bg-red-50/40' : 'hover:bg-gray-50/50'}`}>
                        ...
                        <td className="px-3 py-3">
                          ...
                          className="w-full px-2 py-1.5 border border-gray-200 rounded-lg text-xs text-gray-600 focus:outline-none focus:ring-1 focus:ring-purple-400"
                          placeholder="Remarks..." />
            ...
            <div className="p-4 border-t bg-gray-50 flex items-center justify-between">
              ...
              <div className="flex gap-3">
                ...
                <button className="flex items-center gap-2 px-6 py-2.5 bg-gradient-to-r from-purple-600 to-violet-600 text-white rounded-xl font-bold text-sm hover:opacity-90 shadow-md shadow-purple-200">
