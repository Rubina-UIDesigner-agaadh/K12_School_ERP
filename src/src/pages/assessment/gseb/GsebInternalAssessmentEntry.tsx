...
export function GsebInternalAssessmentEntry() {
    ...
    <div className="p-6 space-y-5 bg-gray-50 min-h-screen">
      ...
      <div className="bg-white rounded-xl border border-gray-200 shadow-sm overflow-hidden">
            ...
            <table className="w-full text-sm border-collapse">
              <thead>
                ...
                <th
                  key={e.id}
                  colSpan={2}
                  className="px-4 py-3 text-center text-xs font-bold text-teal-700 uppercase bg-teal-50 border-l border-teal-200">
                  ...
                  <th className="px-4 py-3 text-center text-xs font-bold text-gray-500 uppercase bg-green-50 border-l border-green-200">
                    Total
                    <br />
                  ...
                  <th className="px-4 py-3 text-center text-xs font-bold text-gray-500 uppercase bg-green-50">
                    %
                  </th>
                  <th className="px-4 py-3 text-center text-xs font-bold text-gray-500 uppercase bg-green-50">
                    Grade
                ...
                <tr className="bg-white border-b">
                  ...
                  {exams.map((e) =>
                <Fragment key={e.id}>
                      <th className="px-3 py-2 text-center text-[10px] font-semibold text-gray-400 uppercase bg-teal-50/50 border-l border-teal-100">
                        Marks
                      </th>
                      <th className="px-3 py-2 text-center text-[10px] font-semibold text-gray-400 uppercase bg-teal-50/50">
                        Grade
                      </th>
                    </Fragment>
                )}
                  <th className="px-4 py-2 bg-green-50/50 border-l border-green-100"></th>
                  <th className="px-4 py-2 bg-green-50/50"></th>
                  <th className="px-4 py-2 bg-green-50/50"></th>
                </tr>
              </thead>
                ...
                return (
                  <tr
                    ...
                    className="hover:bg-gray-50/50 transition-colors">
                      ...
                      return (
                        <Fragment key={e.id}>
                            <td className="px-3 py-3 text-center bg-teal-50/30 border-l border-teal-100">
                              <input
                              type="text"
                              value={v}
                              onChange={(ev) =>
                      ...
                      <td className="px-4 py-3 text-center bg-green-50/30 border-l border-green-100 font-black text-gray-900">
                        {total > 0 ? total : '—'}
                      </td>
                      <td className="px-4 py-3 text-center bg-green-50/30 font-semibold text-gray-700">
                        {total > 0 ? `${pct}%` : '—'}
                      </td>
          ...
          <div className="p-4 border-t bg-gray-50 flex items-center justify-between">
            ...
            <button className="flex items-center gap-2 px-6 py-3 bg-gradient-to-r from-teal-600 to-green-600 text-white rounded-xl font-bold text-sm hover:opacity-90 shadow-md shadow-teal-200">
