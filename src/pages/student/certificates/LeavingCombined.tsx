...
{ value: 'Completed schooling', label: 'Completed schooling' },
...
{ id: '1', firstName: 'Rahul', lastName: 'Sharma', name: 'Rahul Sharma', suId: 'SU-2024-001', grNo: 'GR001', admissionNo: 'ADM2024001', class: '10', section: 'A', department: 'Science', rollNo: '15', fatherName: 'Ramesh Sharma', motherName: 'Sunita Sharma', dob: '2008-05-15', gender: 'Male', contact: '9876543201', email: 'rahul@example.com', admissionDate: '2020-04-01' },
{ id: '2', firstName: 'Priya', lastName: 'Patel', name: 'Priya Patel', suId: 'SU-2024-002', grNo: 'GR002', admissionNo: 'ADM2024002', class: '10', section: 'A', department: 'Science', rollNo: '08', fatherName: 'Suresh Patel', motherName: 'Kavita Patel', dob: '2008-08-22', gender: 'Female', contact: '9876543202', email: 'priya@example.com', admissionDate: '2020-04-01' },
{ id: '3', firstName: 'Amit', lastName: 'Kumar', name: 'Amit Kumar', suId: 'SU-2024-003', grNo: 'GR003', admissionNo: 'ADM2024003', class: '10', section: 'B', department: 'Science', rollNo: '22', fatherName: 'Vijay Kumar', motherName: 'Meena Kumar', dob: '2008-03-10', gender: 'Male', contact: '9876543203', email: 'amit@example.com', admissionDate: '2020-04-01' },
{ id: '4', firstName: 'Sneha', lastName: 'Gupta', name: 'Sneha Gupta', suId: 'SU-2024-004', grNo: 'GR004', admissionNo: 'ADM2024004', class: '10', section: 'B', department: 'Commerce', rollNo: '05', fatherName: 'Anil Gupta', motherName: 'Rekha Gupta', dob: '2008-11-28', gender: 'Female', contact: '9876543204', email: 'sneha@example.com', admissionDate: '2020-04-01' },
{ id: '5', firstName: 'Ravi', lastName: 'Singh', name: 'Ravi Singh', suId: 'SU-2024-005', grNo: 'GR005', admissionNo: 'ADM2024005', class: '10', section: 'A', department: 'Science', rollNo: '12', fatherName: 'Mahendra Singh', motherName: 'Saroj Singh', dob: '2008-07-19', gender: 'Male', contact: '9876543205', email: 'ravi@example.com', admissionDate: '2020-04-01' },
{ id: '6', firstName: 'Anjali', lastName: 'Verma', name: 'Anjali Verma', suId: 'SU-2024-006', grNo: 'GR006', admissionNo: 'ADM2024006', class: '9', section: 'A', department: 'Commerce', rollNo: '03', fatherName: 'Rakesh Verma', motherName: 'Asha Verma', dob: '2009-01-05', gender: 'Female', contact: '9876543206', email: 'anjali@example.com', admissionDate: '2021-04-01' },
{ id: '7', firstName: 'Vikram', lastName: 'Yadav', name: 'Vikram Yadav', suId: 'SU-2024-007', grNo: 'GR007', admissionNo: 'ADM2024007', class: '9', section: 'B', department: 'Arts', rollNo: '18', fatherName: 'Shyam Yadav', motherName: 'Kamla Yadav', dob: '2009-09-12', gender: 'Male', contact: '9876543207', email: 'vikram@example.com', admissionDate: '2021-04-01' },
{ id: '8', firstName: 'Pooja', lastName: 'Joshi', name: 'Pooja Joshi', suId: 'SU-2024-008', grNo: 'GR008', admissionNo: 'ADM2024008', class: '9', section: 'A', department: 'Science', rollNo: '11', fatherName: 'Dinesh Joshi', motherName: 'Geeta Joshi', dob: '2009-04-25', gender: 'Female', contact: '9876543208', email: 'pooja@example.com', admissionDate: '2021-04-01' },
{ id: '9', firstName: 'Karan', lastName: 'Mehta', name: 'Karan Mehta', suId: 'SU-2024-009', grNo: 'GR009', admissionNo: 'ADM2024009', class: '11', section: 'A', department: 'Science', rollNo: '07', fatherName: 'Ajay Mehta', motherName: 'Neha Mehta', dob: '2007-06-30', gender: 'Male', contact: '9876543209', email: 'karan@example.com', admissionDate: '2019-04-01' },
{ id: '10', firstName: 'Neha', lastName: 'Reddy', name: 'Neha Reddy', suId: 'SU-2024-010', grNo: 'GR010', admissionNo: 'ADM2024010', class: '11', section: 'B', department: 'Commerce', rollNo: '14', fatherName: 'Suresh Reddy', motherName: 'Lakshmi Reddy', dob: '2007-12-08', gender: 'Female', contact: '9876543210', email: 'neha@example.com', admissionDate: '2019-04-01' },
{ id: '11', firstName: 'Arjun', lastName: 'Nair', name: 'Arjun Nair', suId: 'SU-2024-011', grNo: 'GR011', admissionNo: 'ADM2024011', class: '12', section: 'A', department: 'Science', rollNo: '02', fatherName: 'Gopalan Nair', motherName: 'Prema Nair', dob: '2006-02-14', gender: 'Male', contact: '9876543211', email: 'arjun@example.com', admissionDate: '2018-04-01' },
{ id: '12', firstName: 'Divya', lastName: 'Iyer', name: 'Divya Iyer', suId: 'SU-2024-012', grNo: 'GR012', admissionNo: 'ADM2024012', class: '12', section: 'A', department: 'Science', rollNo: '09', fatherName: 'Krishnan Iyer', motherName: 'Radha Iyer', dob: '2006-10-20', gender: 'Female', contact: '9876543212', email: 'divya@example.com', admissionDate: '2018-04-01' }];
...
// Main Component
export function LeavingCombined() {
  // Tab State
  ...
  const handleGenerateSingle = () => {
    if (!selectedStudent || !selectedReason || !selectedConduct) return;
  ...
  const handleGenerateBulk = () => {
    if (selectedStudents.length === 0 || !selectedReason || !selectedConduct) return;
  ...
  <div className="space-y-6">
    ...
    <Card className="p-4">
          <h3 className="text-base font-semibold text-gray-900 mb-4 flex items-center gap-2">
            <LogOutIcon className="w-5 h-5 text-blue-600" />
              ...
              <div className="flex items-center gap-4">
                ...
                <div>
                  ...
                  <div className="flex flex-wrap gap-3 mt-1 text-sm text-gray-500">
                    ...
                    <span>Admission: {selectedStudent.admissionDate}</span>
                  </div>
                </div>
              </div>
          ...
          disabled={!selectedReason || !selectedConduct || isGeneratingSingle}>
          ...
          <><PlusIcon className="w-4 h-4 mr-2" /> Generate Certificate</>
            ...
            <Button variant="outline" onClick={() => handlePreview(selectedStudent)} disabled={!selectedReason || !selectedConduct}>
      ...
      <Card className="p-4">
        <div className="flex items-center justify-between mb-4">
          <h3 className="text-base font-semibold text-gray-900 flex items-center gap-2">
            ...
            Bulk Leaving Certificate Generation
          </h3>
          {hasActiveFilters &&
        <Button variant="ghost" size="sm" onClick={handleClearFilters}>
      ...
      <Card className="p-4">
        ...
        <div className="flex items-center justify-between mt-4 pt-4 border-t border-gray-200">
          ...
          <div className="flex gap-3">
            ...
            disabled={selectedStudents.length === 0 || !selectedReason || !selectedConduct || isGeneratingBulk}>
  ...
  <Card className="p-4">
      <div className="flex items-center justify-between mb-4">
        <h3 className="text-lg font-semibold text-gray-900">Leaving Certificate Issue History</h3>
        <div className="flex gap-2">
    ...
    <div className="overflow-x-auto">
          <table className="min-w-full divide-y divide-gray-200">
            <thead className="bg-gray-50">
              <tr>
                ...
                <th className="px-4 py-3 text-left text-xs font-medium text-gray-500 uppercase">Leaving Date</th>
          ...
          <tr key={cert.id} className="hover:bg-gray-50">
                  ...
                  <td className="px-4 py-3 text-sm text-gray-600">{cert.reason}</td>
                  <td className="px-4 py-3 text-sm text-gray-600">{cert.leavingDate}</td>
    ...
    <div className="text-center py-12">
          <LogOutIcon className="w-12 h-12 mx-auto text-gray-400 mb-4" />
          <h4 className="text-lg font-medium text-gray-700 mb-1">No Leaving Certificates Issued Yet</h4>
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
        <div>
          ...
          <p className="text-sm text-gray-500 mt-1">
            Generate single or bulk leaving certificates for students
          </p>
        </div>
        <div className="flex gap-2">
      ...
      <Modal
        ...
        title="Leaving Certificate Preview"
        size="xl">

        {previewStudent &&
        <div className="space-y-4">
            <div className="bg-gray-100 rounded-lg p-6">
              <div className="bg-white border-4 border-double border-gray-300 p-8 max-w-2xl mx-auto">
                <div className="text-center mb-6">
                  <h2 className="text-2xl font-bold text-gray-800">LEAVING CERTIFICATE</h2>
                ...
                <div className="space-y-4 text-sm">
                  <div className="grid grid-cols-2 gap-4">
                    <div>
                      ...
                      <span className="ml-2 font-medium">{previewStudent.grNo}</span>
                    </div>
                    <div>
                      <span className="text-gray-500">SU ID:</span>
                      <span className="ml-2 font-medium">{previewStudent.suId}</span>
                    </div>
                  </div>

                  <div className="border-t border-gray-200 pt-4">
                    <p className="text-gray-700">
                      This is to certify that <span className="font-bold text-blue-800">{previewStudent.name}</span>,
                      Son/Daughter of <span className="font-medium">{previewStudent.fatherName}</span>,
                  ...
                  <div className="grid grid-cols-2 gap-4 py-4">
                    <div>
                      ...
                      <span className="ml-2 font-medium">{previewStudent.dob}</span>
                    </div>
                    <div>
                      <span className="text-gray-500">Gender:</span>
                      <span className="ml-2 font-medium">{previewStudent.gender}</span>
                    </div>
                    <div>
                      <span className="text-gray-500">Admission Date:</span>
                      <span className="ml-2 font-medium">{previewStudent.admissionDate}</span>
                    </div>
                    <div>
                      <span className="text-gray-500">Last Class Attended:</span>
                      <span className="ml-2 font-medium">Class {previewStudent.class}-{previewStudent.section}</span>
                    </div>
                    <div>
                      <span className="text-gray-500">Date of Leaving:</span>
                      <span className="ml-2 font-medium">{leavingDate}</span>
                    </div>
                    <div>
                      <span className="text-gray-500">Reason for Leaving:</span>
                      <span className="ml-2 font-medium">{selectedReason || 'Not specified'}</span>
                    </div>
                    <div>
                      <span className="text-gray-500">Conduct & Behaviour:</span>
                      <span className="ml-2 font-medium">{selectedConduct || 'Not specified'}</span>
                    </div>
                  </div>
                ...
                <div className="mt-8 flex justify-between text-sm text-gray-600 pt-4 border-t border-gray-200">
                  <div>
                    <p>Date: {issueDate}</p>
                    <p className="mt-1">Place: _____________</p>
                  </div>
      ...
      <Modal
        ...
        onClose={() => {setShowBulkSuccess(false);setSelectedStudents([]);setSelectedReason('');setSelectedConduct('');}}
        ...
        <div className="space-y-6">
          <div className="text-center">
            ...
            <h3 className="text-lg font-semibold text-gray-900">{selectedStudents.length} Leaving Certificates Generated</h3>
          ...
          <div className="flex justify-end gap-2">
            ...
            <Button variant="primary" onClick={() => {setShowBulkSuccess(false);setSelectedStudents([]);setSelectedReason('');setSelectedConduct('');}}>Done</Button>
          </div>
        </div>
      </Modal>
    </div>);
...
export default LeavingCombined;