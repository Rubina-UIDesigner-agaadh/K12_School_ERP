...
{ value: 'Admission Purpose', label: 'Admission Purpose' },
{ value: 'Railway Concession', label: 'Railway Concession' },
...
{ value: 'default', label: 'Default Bonafide Template' },
{ value: 'detailed', label: 'Detailed Bonafide Template' },
{ value: 'simple', label: 'Simple Bonafide Template' }];
...
// Main Component
export function BonafideCombined() {
  // Tab State
  ...
  const generateCertificateNumber = (index: number = 0) => {
    ...
    return `BON-${year}-${number}`;
  };

  const handleGenerateSingle = () => {
    if (!selectedStudent || !selectedPurpose) return;
  ...
  const handleGenerateBulk = () => {
    if (selectedStudents.length === 0 || !selectedPurpose) return;
  ...
  <div className="space-y-6">
    ...
    <Card className="p-4">
          ...
          disabled={!selectedPurpose || isGeneratingSingle}>
          ...
          <><PlusIcon className="w-4 h-4 mr-2" /> Generate Certificate</>
            ...
            <Button variant="outline" onClick={() => handlePreview(selectedStudent)} disabled={!selectedPurpose}>
      ...
      <Card className="p-4">
        ...
        <div className="flex items-center justify-between mt-4 pt-4 border-t border-gray-200">
          ...
          <div className="flex gap-3">
            ...
            disabled={selectedStudents.length === 0 || !selectedPurpose || isGeneratingBulk}>
  ...
  <Card className="p-4">
    ...
    <div className="overflow-x-auto">
          ...
          <tr key={cert.id} className="hover:bg-gray-50">
                  ...
                  <td className="px-4 py-3 text-sm text-gray-600">{cert.purpose}</td>
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
        <div>
          ...
          <p className="text-sm text-gray-500 mt-1">
            Generate single or bulk bonafide certificates for students
          </p>
        </div>
        <div className="flex gap-2">
            ...
            <div className="bg-gray-100 rounded-lg p-6">
              <div className="bg-white border-4 border-double border-gray-300 p-8 max-w-2xl mx-auto relative">
                ...
                <div className="absolute inset-0 flex items-center justify-center opacity-5 pointer-events-none">
                  <Building2Icon className="w-64 h-64 text-gray-900" />
                </div>
                ...
                <div className="text-gray-700 leading-relaxed mb-8">
                  <p className="mb-4">
                    This is to certify that <strong className="text-green-800">{previewStudent.name}</strong>,
                    {previewStudent.gender === 'Male' ? ' Son' : ' Daughter'} of <strong>{previewStudent.fatherName}</strong>,
                    is a bonafide student of this school.
                  </p>
                  <p className="mb-4">
                    {previewStudent.gender === 'Male' ? 'He' : 'She'} is studying in Class <strong>{previewStudent.class}-{previewStudent.section}</strong> during the academic year <strong>2024-2025</strong>.
                  </p>
                  <p className="mb-4">
                    {previewStudent.gender === 'Male' ? 'His' : 'Her'} date of birth as per school records is <strong>{previewStudent.dob}</strong>.
                  </p>
                  <p className="mb-4">
                    {previewStudent.gender === 'Male' ? 'His' : 'Her'} GR Number is <strong>{previewStudent.grNo}</strong> and Student ID is <strong>{previewStudent.suId}</strong>.
                  </p>
                  <p className="mb-4">
                    This certificate is issued for the purpose of <strong>{selectedPurpose || '[Purpose]'}</strong>.
                  </p>
                  {remarks &&
      ...
      <Modal
        ...
        onClose={() => {setShowBulkSuccess(false);setSelectedStudents([]);setSelectedPurpose('');}}
        ...
        <div className="space-y-6">
          <div className="text-center">
            ...
            <p className="text-sm text-gray-500">All bonafide certificates are ready for printing</p>
          </div>
          ...
          <div className="bg-gray-50 rounded-lg p-4 grid grid-cols-3 gap-4 text-center">
            ...
            <div>
              <p className="text-2xl font-bold text-blue-600">{selectedPurpose?.split(' ')[0] || '-'}</p>
          ...
          <div className="flex justify-end gap-2">
            ...
            <Button variant="primary" onClick={() => {setShowBulkSuccess(false);setSelectedStudents([]);setSelectedPurpose('');}}>Done</Button>
          </div>
        </div>
      </Modal>
    </div>);
