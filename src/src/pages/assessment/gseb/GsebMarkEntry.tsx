...
export function GsebMarkEntry() {
  ...
  const MAX = subjectInfo?.max ?? 100;
  const PASS = subjectInfo?.pass ?? 33;
  const handleSearch = () => {
      ...
      <div className="flex items-center gap-3">
        ...
        <div>
          <h1 className="text-2xl font-bold text-gray-900">
            GSEB — Subject Wise Mark Entry
          </h1>
          <p className="text-sm text-gray-500">
            Enter marks subject-wise for GSEB students
          </p>
        </div>
      </div>
      ...
      <div className="bg-white rounded-xl border border-gray-200 shadow-sm p-5">
        ...
        <div className="mt-4 flex justify-end">
          <button
            ...
            className="flex items-center gap-2 px-5 py-2.5 bg-gradient-to-r from-teal-600 to-green-600 text-white rounded-lg font-medium text-sm hover:opacity-90 transition-opacity shadow-sm">
      ...
      <>
          <div className="bg-teal-50 border border-teal-200 rounded-xl p-4 flex flex-wrap items-center gap-4">
            ...
            <div className="ml-auto flex gap-2">
              <span className="px-3 py-1 bg-teal-100 text-teal-700 rounded-full text-xs font-semibold border border-teal-200">
                Max: {MAX}
              </span>
          ...
          <div className="bg-white rounded-xl border border-gray-200 shadow-sm overflow-hidden">
                    ...
                    <tr
                      ...
                      className={`transition-colors ${status === 'invalid' ? 'bg-red-50/60' : s.isAbsent ? 'bg-gray-50' : isBelowPass ? 'bg-orange-50/40' : 'hover:bg-gray-50/50'}`}>
                        ...
                        <td className="px-4 py-3">
                          <span className="inline-flex items-center justify-center w-9 h-9 rounded-full bg-teal-100 text-teal-700 text-sm font-bold">
                            {s.rollNo}
                          </span>
                        </td>
            ...
            <div className="p-4 border-t bg-gray-50 flex justify-end">
              <button className="flex items-center gap-2 px-6 py-3 bg-gradient-to-r from-teal-600 to-green-600 text-white rounded-xl font-bold text-sm hover:opacity-90 transition-opacity shadow-md shadow-teal-200">
