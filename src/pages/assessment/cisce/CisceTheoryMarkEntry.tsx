...
export function CisceTheoryMarkEntry() {
  ...
  const PASS = subjectInfo?.pass ?? 32;
  const handleSearch = () => {
  ...
  return (
    <div className="p-6 space-y-5 bg-gray-50 min-h-screen">
      <div className="flex items-center gap-3">
        ...
        <div>
          <h1 className="text-2xl font-bold text-gray-900">
            CISCE — Subject Wise Mark Entry
          </h1>
          <p className="text-sm text-gray-500">
            Enter marks subject-wise for CISCE (ICSE/ISC) students
          </p>
        </div>
      </div>
      ...
      <div className="bg-white rounded-xl border border-gray-200 shadow-sm p-5">
        ...
        <div className="mt-4 flex justify-end">
          <button
            ...
            className="flex items-center gap-2 px-5 py-2.5 bg-gradient-to-r from-purple-600 to-violet-600 text-white rounded-lg font-medium text-sm hover:opacity-90 transition-opacity shadow-sm">
      ...
      {searched &&
      <>
          <div className="bg-purple-50 border border-purple-200 rounded-xl p-4 flex flex-wrap items-center gap-4">
          ...
          <div className="bg-white rounded-xl border border-gray-200 shadow-sm overflow-hidden">
                    ...
                    <tr
                      ...
                      className={`transition-colors ${status === 'invalid' ? 'bg-red-50/60' : s.isAbsent ? 'bg-gray-50' : isBelowPass ? 'bg-orange-50/40' : 'hover:bg-gray-50/50'}`}>
                        ...
                        <td className="px-4 py-3">
                          <span className="inline-flex items-center justify-center w-9 h-9 rounded-full bg-purple-100 text-purple-700 text-sm font-bold">
                            {s.rollNo}
                          </span>
                        </td>
            ...
            <div className="p-4 border-t bg-gray-50 flex justify-end">
              <button className="flex items-center gap-2 px-6 py-3 bg-gradient-to-r from-purple-600 to-violet-600 text-white rounded-xl font-bold text-sm hover:opacity-90 transition-opacity shadow-md shadow-purple-200">
