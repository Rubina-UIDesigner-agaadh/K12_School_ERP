...
export function TeamsAssignmentSync() {
  return (
      ...
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-sm text-gray-500">
            Sync Teams classes and assignments with the school management system
          </p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
        <Card>
          <div className="p-2">
            ...
            <p className="text-sm text-gray-500">Teams Classes</p>
          </div>
        </Card>
        <Card>
          <div className="p-2">
        ...
        <Card>
          <div className="p-2">
            ...
            <p className="text-sm text-gray-500">Students in Teams</p>
          </div>
        </Card>
        <Card>
          <div className="p-2">
